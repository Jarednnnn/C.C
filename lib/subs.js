...
import { updateBotGroups } from './system/groupUpdater.js';
...
delete commandFlags[senderId]
     ...
     // await joinChannels(sock)
      ...
      // <-- NUEVO: Actualizar grupos del sub-bot
      await updateBotGroups(sock);
      setInterval(() => updateBotGroups(sock), 30 * 60 * 1000);
    }
